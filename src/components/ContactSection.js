...
const ContactSection = ({ setShowBookingModal }) => {
  ...
  // Contact data
  const contactData = {
    address: 'Av. Principal 1234, Zona Premium, Torre Ejecutiva, Ciudad, CP 12345',
    phone: '+1 (555) 123-4567',
    email: 'reservas@gentlemansclub.com',
    hours: [
          ...
          <div className="contact-section__info">
            ...
            >
              <div className="contact-address">
                ...
                <p>Zona Premium, Torre Ejecutiva</p>
                <p>Ciudad, CP 12345</p>
              </div>
              {deviceInfo.isMobile && (
            ...
            <div className="contact-direct">
              ...
              <div className="contact-direct__items">
                ...
                <div 
                  ...
                  onClick={() => handleEmail(contactData.email, 'Consulta desde The Gentleman\'s Club')}
                  role="button"
                  tabIndex={0}
                >
              ...
              <div className="contact-section__badge">
                <div className="contact-section__badge-content">
                  <div className="contact-section__badge-info">
                    <p className="contact-section__badge-label">EXPERIENCIA PREMIUM</p>
                    <p className="contact-section__badge-text">Desde 1995</p>
                  </div>
